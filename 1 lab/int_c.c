    ...
    /* [string][in] */ const unsigned char *szOutput)
{
    ...
    NdrClientCall2(
                  ...
                  (PFORMAT_STRING) &int__MIDL_ProcFormatString.Format[0],
    ...
    /* [out] */ int *check_eof)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Example1_StubDesc,
                  (PFORMAT_STRING) &int__MIDL_ProcFormatString.Format[30],
                  ( unsigned char * )&path);
    ...
    /* [in] */ int check_eof)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Example1_StubDesc,
                  (PFORMAT_STRING) &int__MIDL_ProcFormatString.Format[90],
    ...
    /* [in] */ int index)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Example1_StubDesc,
                  (PFORMAT_STRING) &int__MIDL_ProcFormatString.Format[150],
                  ( unsigned char * )&path);
    return ( int  )_RetVal.Simple;
    ...
    /* [out] */ int *index)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Example1_StubDesc,
                  (PFORMAT_STRING) &int__MIDL_ProcFormatString.Format[192],
                  ( unsigned char * )&login);
    return ( int  )_RetVal.Simple;
    ...
    /* [in] */ int index)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&Example1_StubDesc,
                  (PFORMAT_STRING) &int__MIDL_ProcFormatString.Format[240],
                  ( unsigned char * )&index);
    return ( int  )_RetVal.Simple;
